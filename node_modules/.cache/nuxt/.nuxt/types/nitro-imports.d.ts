declare global {
  ...
  const asSitemapUrl: typeof import('../../../../@nuxtjs/sitemap/dist/runtime/server/composables/asSitemapUrl').asSitemapUrl
  ...
  const createSitePathResolver: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/utils').createSitePathResolver
  ...
  const defineSitemapEventHandler: typeof import('../../../../@nuxtjs/sitemap/dist/runtime/server/composables/defineSitemapEventHandler').defineSitemapEventHandler
  ...
  const getBotDetection: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getBotDetection').getBotDetection
  const getBotInfo: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getBotDetection').getBotInfo
  ...
  const getNitroOrigin: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/getNitroOrigin').getNitroOrigin
  const getPathRobotConfig: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getPathRobotConfig').getPathRobotConfig
  ...
  const getSiteConfig: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/getSiteConfig').getSiteConfig
  const getSiteIndexable: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/getSiteIndexable').getSiteIndexable
  const getSiteRobotConfig: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getSiteRobotConfig').getSiteRobotConfig
  ...
  const isBot: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getBotDetection').isBot
  ...
  const updateSiteConfig: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/updateSiteConfig').updateSiteConfig
  ...
  const useNitroOrigin: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/useNitroOrigin').useNitroOrigin
  const useRuntimeConfig: typeof import('../../../../nitropack/dist/runtime/internal/config').useRuntimeConfig
  const useRuntimeConfigNuxtRobots: typeof import('../../../../@nuxtjs/robots/dist/runtime/server/composables/useRuntimeConfigNuxtRobots').useRuntimeConfigNuxtRobots
  const useSession: typeof import('../../../../h3').useSession
  const useSiteConfig: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/useSiteConfig').useSiteConfig
  const useStorage: typeof import('../../../../nitropack/dist/runtime/internal/storage').useStorage
  const withSiteTrailingSlash: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/utils').withSiteTrailingSlash
  const withSiteUrl: typeof import('../../../../nuxt-site-config/dist/runtime/server/composables/utils').withSiteUrl
  const writeEarlyHints: typeof import('../../../../h3').writeEarlyHints
}
// for type re-export
declare global {
  // @ts-ignore
  export type { BotDetectionContext } from '../../../../@nuxtjs/robots/dist/runtime/server/composables/getBotDetection.d'
  import('../../../../@nuxtjs/robots/dist/runtime/server/composables/getBotDetection.d')
}
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { defineSitemapEventHandler } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/defineSitemapEventHandler';
export { asSitemapUrl } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/sitemap/dist/runtime/server/composables/asSitemapUrl';
export { parseMarkdown } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/mdc/dist/runtime/parser';
export { getNitroOrigin } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/getNitroOrigin';
export { getSiteConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/getSiteConfig';
export { getSiteIndexable } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/getSiteIndexable';
export { updateSiteConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/updateSiteConfig';
export { useNitroOrigin } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/useNitroOrigin';
export { useSiteConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/useSiteConfig';
export { createSitePathResolver, withSiteTrailingSlash, withSiteUrl } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/nuxt-site-config/dist/runtime/server/composables/utils';
export { getBotDetection, isBot, getBotInfo } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getBotDetection';
export { getPathRobotConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getPathRobotConfig';
export { getSiteRobotConfig } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/robots/dist/runtime/server/composables/getSiteRobotConfig';
export { useRuntimeConfigNuxtRobots } from '/Users/knothing/Documents/ASLY/AI-Project/aiknothing/node_modules/@nuxtjs/robots/dist/runtime/server/composables/useRuntimeConfigNuxtRobots';